...
import { Data_Center, Data_Main, ToolData, languageData } from "./data"
      ...
      <ChakraProvider theme={theme}>
        ...
        <Box direction="column" height="100%" position={"relative"}>
            ...
            {page == 2 ? (
              <Flex display="flex" flexDirection="row" width={"100%"} height={screenHeight}>
                <Box bg={backcolor} width={"50%"} paddingTop={"10%"} paddingBottom={"5%"}>
                  ...
                  <Spline  scene="https://prod.spline.design/f4fqZc5DdUvZLstL/scene.splinecode" onLoad={onLoad} />
                </Box>
                <LightEffectBio />
              </Flex>
            ) : (
          ...
          <Box display={"flex"} bg={backcolor} width={"100%"} height={screenHeight}>
            {page == 3 ? (
              <>
                  ...
                  <Spline  scene="https://prod.spline.design/sXPKZwHx2Eqk9u-z/scene.splinecode" onLoad={onLoadwroclaw} />
              </>
            ) : (
              <></>
            )}
          ...
          <Box
            ...
            {page == 4 ? (
              <>
                <LanguageBox props={languageData} />
                <DevBox props={ToolData} />

                <Flex mt={"150px"} w="100%" justifyContent="space-between">
                  <Flex justify="left" w={"100%"}>
                    <PieChart
                      data={Data_Main}
                      data_central={Data_Center}
                      shine={Repo}
                      width={500}
                      height={500}
                      chartdata={chartdata}
